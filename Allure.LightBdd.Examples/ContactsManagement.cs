using Allure.LightBdd.Examples.Context;
...
namespace Allure.LightBdd.Examples
{
    /// <summary>
...
I want to add, browse and remove my contacts")]
    [Label("Story-6")]
    [AllureNUnit]
    public class ContactsManagement : FeatureFixture
    {
        [Scenario]
        [Label("Ticket-8")]
        public Task Contact_book_should_allow_me_to_add_multiple_contacts()
        {
            // Console.WriteLine($"{Thread.CurrentThread.ManagedThreadId} {nameof(Contact_book_should_allow_me_to_add_multiple_contacts)}");
            return Runner.WithContext<ContactsManagementContext>().RunScenarioAsync(
        ...
        [Scenario]
        [Label("Ticket-9")]
        public Task Contact_book_should_allow_me_to_remove_contacts()
        {
            return Runner.WithContext<ContactsManagementContext>().RunScenarioAsync(
        ...
        [Scenario]
        [Label("Ticket-9")]
        public Task Contact_book_should_allow_me_to_remove_all_contacts()
        {
            return Runner.WithContext<ContactsManagementContext>().RunScenarioAsync(
        ...
        [Scenario]
        public Task Displaying_contacts_alphabetically()
        {
            return Runner.WithContext<ContactsManagementContext>().RunScenarioAsync(
